...
const PROJECTS: Project[] = [
  ...
  { id: "3", label: "COLLAGE ANIMATIONS", image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=500&q=80", x: 10, y: 15, size: "md", rotation: 0 },
  ...
  { id: "10", label: "TO NIE POP", image: "https://images.unsplash.com/photo-1549490349-8643362247b5?w=500&q=80", x: -25, y: 20, size: "sm", rotation: 0 },
  { id: "11", label: "TOUR", image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&q=80", x: -40, y: 30, size: "sm", rotation: 0 },
  { id: "12", label: "KACPERCZYK 2024", image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&q=80", x: -30, y: 38, size: "md", rotation: 0 },
  ...
  { id: "17", label: "SOLAR BIAŁAS", image: "https://images.unsplash.com/photo-1504593811423-6dd665756598?w=500&q=80", x: 32, y: 22, size: "sm", rotation: 0 },
  { id: "18", label: "CHANEL", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=500&q=80", x: 40, y: 35, size: "sm", rotation: 0 },
  ...
  { id: "20", label: "ALBOALBO", image: "https://images.unsplash.com/photo-1498931299472-f7a63a5a1cfa?w=500&q=80", x: -10, y: 35, size: "sm", rotation: 0 },
  { id: "21", label: "FANTASMAGORIE", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&q=80", x: -5, y: 45, size: "sm", rotation: 0 },
  { id: "22", label: "MERCH", image: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=500&q=80", x: 8, y: 40, size: "sm", rotation: 0 },
  { id: "23", label: "NEWONCE", image: "https://images.unsplash.com/photo-1508704019882-f9cf40e475b4?w=500&q=80", x: 20, y: 42, size: "md", rotation: 0 },
];
